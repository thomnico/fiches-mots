...
Utilise Pixabay et Unsplash pour la recherche d'images.
...
class ImageSearcher:
    ...
    def __init__(self):
        ...
        if not self.pixabay_api_key or not self.unsplash_access_key:
            print("⚠️  Clés API manquantes dans les variables d'environnement")
            print("   Configurez PIXABAY_API_KEY et UNSPLASH_ACCESS_KEY dans .env")
...
def main():
    ...
    print("=" * 60)
    print("Générateur de Fiches Pédagogiques (Pixabay + Unsplash)")
    print("=" * 60)
